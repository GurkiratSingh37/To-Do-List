...
const mailProp = require('../mail/mailProperties');

exports.sendingMails = async(emailId, firstName, lastName)=>{
    const transporter = nodemailer.createTransport({
        host: mailProp.mailProp.host,
        port: mailProp.mailProp.port,
        auth: {
            user: mailProp.mailProp.user,
            pass: mailProp.mailProp.pass
        }
    })
